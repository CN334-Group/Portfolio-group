...
<body id="page-top">
    ...
    <header class="masthead" style="background-image: url(<?php echo $main->bc_img; ?>)">
        <div class="container">
            <div class="masthead-subheading"><br></div>
    ...
    <!-- Educations-->
    <section class="page-section" id="educations">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Educations</h2>
            </div>
                ...
                @if (count($services) > 0)
                    @foreach ($services as $service)
                        <div class="col-md-6 mt-4">
                            ...
                            <p class="text-muted">{{ $service->descriprion }}</p>
                        </div>
                    @endforeach
                @endif
            </div>
