                    ...
                    @if (count($portfolios) > 0)
                        @foreach ($portfolios as $portfolio)
                            <tr>
                                ...
                                <td><img style=" height:10vh" src="{{ url($portfolio->big_image) }}" alt="big_image"></td>
                                <td><img style=" height:10vh" src="{{ url($portfolio->small_image) }}" alt="small_image"></td>
                                <td>{{ Str::limit(strip_tags($portfolio->descriprion), 40) }}</td>
                                <td>
                                    <div class="row">
                                        <div>
